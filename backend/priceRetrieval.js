...
async function calcDSGDPrice() {
  const web3 = new Web3("https://data-seed-prebsc-1-s1.binance.org:8545/");
  const DSGDTokenAddress = "0x25d1d454084Df3B23B0C982bc2E4CC2Dd06a7F12"; //DSGD
  const BUSDTokenAddress = "0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7"; //BUSD
  ...
  try {
    ...
    amountOut = await router.methods
      .getAmountsOut(bnbToSell, [DSGDTokenAddress, BUSDTokenAddress])
      .call();
...
async function calcDRMBPrice() {
  const web3 = new Web3("https://data-seed-prebsc-1-s1.binance.org:8545/");
  const DRMBTokenAddress = "0x54ec93A799ea75c2ED8685d6310f5bF0c37c1bE4"; //DSGD
  const BUSDTokenAddress = "0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7"; //BUSD
  let bnbToSell = web3.utils.toWei("1", "ether");
  let amountOut;
  try {
    ...
    amountOut = await router.methods
      .getAmountsOut(bnbToSell, [DRMBTokenAddress, BUSDTokenAddress])
      .call();
    amountOut = web3.utils.fromWei(amountOut[1]);
  } catch (error) {}
  if (!amountOut) return 0;
